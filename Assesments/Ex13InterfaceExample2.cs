...
//If an class implements an interface, it means that the class is providing a concrete implementation for all the members defined in the interfacwhere a reference of the interface type can be used to refer to an object of the class that implements the interface.
namespace SampleConApp.GenericExample
{
    ...
    internal class Ex13InterfacesExample2
    {
